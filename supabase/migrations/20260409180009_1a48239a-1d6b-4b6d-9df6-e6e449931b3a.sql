...
-- Add folder_id to assignments
ALTER TABLE public.assignments ADD COLUMN folder_id UUID REFERENCES public.folders(id) ON DELETE SET NULL;
...
CREATE INDEX idx_assignments_folder_id ON public.assignments(folder_id);
